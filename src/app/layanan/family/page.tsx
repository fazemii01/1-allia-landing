...
export default function FamilyLayanan() {
  const benefits = [
    "Mediasi Anggota Keluarga: Menghubungkan orang tua, anak, maupun saudara kandung dalam ruang mediasi yang aman.",
    "Resolusi Konflik Domestik: Membantu memproses duka keluarga, perceraian, trauma bersama, atau perpecahan internal.",
    "Paket Sesi Terarah: Konseling keluarga terstruktur dalam paket 3 sesi untuk pemulihan yang berkesinambungan.",
    "Sesi Offline Khusus: Dijalankan secara tatap muka (offline) langsung di biro psikologi untuk interaksi yang mindful.",
  ];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-7 flex flex-col gap-4 text-center lg:text-left">
                ...
                <p className="text-grey-400 text-sm lg:text-base font-semibold max-w-xl leading-relaxed mx-auto lg:mx-0">
                  Sesi konseling bersama psikolog yang melibatkan dua atau lebih anggota keluarga untuk memproses kendala komunikasi, pola asuh, maupun dinamika keluarga kurang sehat.
                </p>
              ...
              <div className="lg:col-span-5 flex justify-center">
                <div className="w-full max-w-[420px] rounded-3xl overflow-hidden shadow-lg border border-white aspect-[4/3]">
                  <img
                    src="https://images.unsplash.com/photo-1542037104857-ffbb0b9155fb?q=80&w=600"
                    alt="Konseling Keluarga"
        ...
        <section className="container mx-auto px-4 lg:px-10 py-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            <div className="border border-grey-200 rounded-2xl p-6 text-center shadow-sm">
              <div className="text-xs text-grey-400 font-bold uppercase mb-2">Struktur Sesi</div>
              <div className="text-xl font-extrabold text-wellme-primary">Paket 3 Sesi</div>
            </div>
            <div className="border border-grey-200 rounded-2xl p-6 text-center shadow-sm">
            ...
            <div className="border border-grey-200 rounded-2xl p-6 text-center shadow-sm">
              ...
              <div className="text-xl font-extrabold text-wellme-primary">Rp 900.000 / Paket</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-wellme-primary text-2xl lg:text-3xl font-extrabold mb-6">
                Mengapa Memilih Konseling Keluarga?
              </h2>
            ...
            <div className="bg-white-wellme rounded-3xl p-8 border border-grey-200 shadow-sm flex flex-col justify-center">
              <h3 className="text-xl font-extrabold text-wellme-primary mb-3">
                Topik Permasalahan Keluarga
              </h3>
              <p className="text-sm text-grey-400 font-semibold mb-6 leading-relaxed">
                Psikolog kami membantu keluarga mendiskusikan berbagai konflik rumah tangga dan pengasuhan, seperti:
              </p>
              <div className="flex flex-wrap gap-2">
                {[
                  "Kesenjangan Komunikasi Antar Generasi",
                  "Pola Asuh Kurang Sehat (Toxic Parenting)",
                  "Dampak Perceraian / Perpisahan Orang Tua",
                  "Konflik Antar Saudara Kandung (Sibling Rivalry)",
                  "Trauma / Duka Bersama Keluarga",
                  "Kenakalan Remaja & Perilaku Anak",
                  "Adaptasi Keluarga Baru (Blended Family)",
                ].map((tag, idx) => (
                  <span
                    key={idx}
