...
export default function CoupleLayanan() {
  const benefits = [
    "Sesi Aman 2-on-1: Konseling aman bersama pasangan didampingi psikolog berlisensi.",
    "Persiapan Pranikah (Premarital): Membangun fondasi komunikasi dan kecocokan sebelum menikah.",
    "Penyelarasan Konflik: Mengidentifikasi hambatan, menyembuhkan luka hubungan, dan menyelaraskan masa depan.",
    "Pilihan Fleksibel: Tersedia sesi secara online maupun tatap muka langsung (offline).",
  ];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-7 flex flex-col gap-4 text-center lg:text-left">
                ...
                <p className="text-grey-400 text-sm lg:text-base font-semibold max-w-xl leading-relaxed mx-auto lg:mx-0">
                  Sesi konseling terarah bersama pasangan dengan psikolog berlisensi untuk memproses dinamika komunikasi, kesiapan pernikahan, dan resolusi konflik.
                </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-wellme-primary text-2xl lg:text-3xl font-extrabold mb-6">
                Mengapa Memilih Konseling Pasangan?
              </h2>
            ...
            <div className="bg-white-wellme rounded-3xl p-8 border border-grey-200 shadow-sm flex flex-col justify-center">
              <h3 className="text-xl font-extrabold text-wellme-primary mb-3">
                Topik Permasalahan Hubungan
              </h3>
              <p className="text-sm text-grey-400 font-semibold mb-6 leading-relaxed">
                Psikolog kami membantu memproses berbagai kendala relasi pasangan premarital dan marital, seperti:
              </p>
              <div className="flex flex-wrap gap-2">
                {[
                  "Kendala Komunikasi & Sering Berdebat",
                  "Kecocokan Karakter & Visi Masa Depan",
                  "Manajemen Finansial Rumah Tangga",
                  "Perselingkuhan & Kepercayaan Retak",
                  "Intervensi Keluarga Besar / Mertua",
                  "Perbedaan Prinsip Pengasuhan Anak",
                  "Kejenuhan / Kehilangan Keintiman",
                ].map((tag, idx) => (
                  <span
                    key={idx}
